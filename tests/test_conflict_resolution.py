...
class TestCatalogLevelConflictDetection:
    """Test catalog-level conflict detection."""

    def test_catalog_level_cas_detects_conflicts(self):
        """CAS should detect conflicts when catalog.seq has advanced."""
        import simpy
        ...
        # Create two transactions at same catalog version (seq=0)
        ...
        # T1 commits, catalog.seq advances to 1
        r1 = catalog.try_CAS(sim, t1)
        assert r1 == True, "T1 should succeed"
