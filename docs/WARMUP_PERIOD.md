...
```bash
python -m icecap.warmup_validation experiments/exp2_1_*/<seed_dir>
```
...
The warmup filter is automatically applied in `icecap/saturation_analysis.py`:
...
`icecap/warmup_validation.py` generates diagnostic plots:
...
python -m icecap.warmup_validation experiments/exp2_1_*/12345 --window-size 30

# Save plot to custom location
python -m icecap.warmup_validation experiments/exp2_1_*/12345 -o my_validation.png
```
...
- Validation script: `icecap/warmup_validation.py`
- Analysis implementation: `icecap/saturation_analysis.py`
